...
### Core Gameplay
- **1v1 Live Duels:** Challenge opponents in real-time. Both players solve the same problem simultaneously, and the fastest one wins!
- **Random Matchmaking:** Instantly find a match with another player in the queue.
- **ELO Rating System:** Earn points when you win and lose points when you are defeated. Ascend through the ranks: Newbie, Apprentice, Veteran, Pro, and Hacker!
- **Live Leaderboard:** Track the top players by rating and win/loss ratio.
...
- **Instant Execution:** Run against sample cases or submit against hidden test cases.
- **Progress Tracking:** Filter the problem arena to show which problems you have solved, attempted, or haven't seen yet.
- **Bookmarks:** Mark problems as "Important" to revisit them later.

## 🛠️ Technology Stack

- **Frontend:** React, Vite, Vanilla CSS modules (Anti-"AI slop" premium glassmorphism UI)
- **Backend:** Node.js, Express
- **Database:** PostgreSQL
- **Real-time Engine:** Socket.io
- **AI Engine:** Google Gemini Pro / Flash API
- **Code Execution:** Secure execution environment for compiling and running multiple programming languages.
